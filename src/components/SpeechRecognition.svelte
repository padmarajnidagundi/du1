<script>
  ...
  const readOutLoud = (mess) => {
    const apps = ['YouTube', 'LinkedIn', 'GitHub' , 'Medium', 'Twitter', 'Bing', 'Quora', 'Gmail']
...
<p class="text-center italic mt-4">Example, 'JavaScript' or 'JavaScript Debugging'. (Only works on Gmail, Quora, YouTube, LinkedIn, GitHub, Medium and Twitter yet.) <br> (Try in Chrome for best results.)</p>
